...
A shared home-improvement app for two people: projects ("quests") with photos, budgets, real quotes and contractor contacts, an inspiration pin board per project, live sync between phones, a bit of XP-and-badges gamification, and an Insights page for costs and timelines.
