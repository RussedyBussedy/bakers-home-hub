          ...
          <div className="mt-4 grid gap-2">
            <div className="flex items-center justify-between gap-4 rounded-xl px-1 py-1.5">
              <span>
                ...
                <span className="block text-[13px] text-ink-3">Flip the page when you move between sections.</span>
              </span>
            ...
            <div className="flex items-center justify-between gap-4 rounded-xl px-1 py-1.5">
              <span>
                ...
                <span className="block text-[13px] text-ink-3">A little texture on the page. Turn it off if scrolling feels heavy.</span>
              </span>
