        ...
        {toasts.map((t) => (
          <motion.div
            ...
            className={cn(
              ...
              t.tone === 'danger' ? 'border-danger/30 bg-danger-soft text-ink' : t.tone === 'xp' ? 'border-gold/40 bg-gold-soft text-ink' : t.tone === 'success' ? 'border-sage/30 bg-sage-soft text-ink' : 'kraft-tag',
            )}
            role="status"
          >
